...
public class Player{
    ...
    public Player(String username, ConnectionType connectionType, PlayerColor color, PersonalBonusTile personalBonusTile){
        this.username = username;
        this.connectionType = connectionType;
        this.color = color;
        this.playerBoard = new PlayerBoard(this, personalBonusTile);
    }
